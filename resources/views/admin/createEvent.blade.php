...
<form action="{{ route('adminInsertEvent')}}" method="post" enctype="multipart/form-data"  class="w-100">
    @csrf
    <div class="row ">
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="form py-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input id="zip" type="number" class="form-control @error('zip') is-invalid @enderror" name="zip" >
                            @error('zip')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="col-md-12 py-4 dateTime-block">
                    <div class="row ">
                        <div class="col-md-6">
                            ...
                            <input id="start_date" type="date" class="@error('start_date') is-invalid @enderror" name="start_date" >
                            @error('end_time')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="end_date" type="date" class="@error('end_date') is-invalid @enderror" name="end_date" >
                            @error('end_time')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row ">
                        <div class="col-md-6">
                            ...
                            <input id="start_time" type="time" class="@error('start_time') is-invalid @enderror" name="start_time" >
                            @error('start_time')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="end_time" type="time" class="@error('end_time') is-invalid @enderror" name="end_time" >
                            @error('end_time')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
